<template>
  ...
  <footer class="p-2 sm:p-4 w-full">
      <div class="max-w-4xl mx-auto transition-all duration-300" :class="{ 'md:max-w-6xl': !sidebarOpen }">
        <div class="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-xl shadow-lg p-2 sm:p-3">
          <!-- Error Message -->
          <div v-if="errorMessage" class="text-[var(--color-error)] text-sm mb-2" role="alert">
            {{ errorMessage }}
          </div>
          ...
          <div>
            ...
            <div class="relative">
              <textarea
                ...
                :disabled="isLoading"
                class="w-full bg-transparent p-2 text-[var(--color-text-primary)] placeholder-[var(--color-text-muted)] focus:outline-none resize-none scrollbar-thin"
                rows="1"
              ...
              <div class="absolute top-2 right-2 text-xs text-[var(--color-text-muted)] pointer-events-none" aria-live="polite">
            ...
            <div class="flex items-center justify-between mt-2">
              ...
              <div class="flex items-center gap-2">
                <select 
                  ...
                  class="text-sm text-[var(--color-text-secondary)] bg-transparent border-0 focus:outline-none cursor-pointer hover:bg-[var(--color-icon-bg)] rounded-md px-2 py-1 max-w-48"
                ...
                <button
                  ...
                  class="text-[var(--color-icon-default)] hover:bg-[var(--color-icon-bg)] rounded-lg p-2 transition-colors"
              ...
              <div class="flex items-center">
                <button
                  ...
                  :class="isLoading ? 'bg-[var(--color-error)] text-white hover:opacity-90' : 'bg-[var(--color-primary-blue)] text-white hover:bg-[var(--color-primary-blue-hover)] disabled:bg-[var(--color-text-muted)] disabled:cursor-not-allowed'"
